...
Use with: score from support.street0_score.final_street0_score(),
...
def get_street0_action_from_recon(
    ...
    Import and pass support.opponent_recon.OpponentRecon.
    """
    from support.opponent_recon import stats_for_street0_context
